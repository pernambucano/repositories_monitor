...
A [Django](https://www.djangoproject.com/) project that aims to help any developer to monitor their github repositories.

It's part of a study about Django and React.

It uses vinta's awesome [Django-React-Boilerplate](https://github.com/vintasoftware/django-react-boilerplate), and as such, most of the rest of this README is from their project.
...
- Create a copy of `repositories_monitor/settings/local.py.example`:
   `cp repositories_monitor/settings/local.py.example repositories_monitor/settings/local.py` (remembering you should replace `repositories_monitor` with your project's name!).
