...
- [ ] Add an email address to the `ADMINS` settings variable in `repositories_monitor/repositories_monitor/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `repositories_monitor/repositories_monitor/settings/production.py`
